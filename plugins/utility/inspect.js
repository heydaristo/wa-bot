...
async function handler(m, { sock }) {
    ...
    if (!text) {
        return m.reply(
            ...
            // FIX: template literal tidak ditutup & kurung tutup reply hilang
        )
    }
    ...
    try {
        ...
        } else if (saluranPattern.test(text) || !isNaN(text)) {
            // FIX: text.endsWith() tanpa argumen selalu return true → dihapus
