...
const pluginConfig = {
    ...
    alias: ['nc'],
    category: 'convert',
    description: 'Mengubah audio menjadi nightcore style',
    usage: '.nightcore (reply audio/video)',
    example: '.nightcore',
    isOwner: false,
    isPremium: false,
    isGroup: false,
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        execSync(`ffmpeg -y -i "${inputPath}" -af "asetrate=44100*1.25,atempo=0.9" -vn "${outputPath}"`, { stdio: 'ignore' })
