...
Selamat Datang! di grup *${groupName}*`,
            ...
            const { createWelcomeCardV4 } = require('../../src/lib/welcomeCard')
            let canvasV4 = null
            try {
                canvasV4 = await createWelcomeCardV4(userName, ppUrl, groupName, memberCount)
            } catch (e) {
                console.error('Welcome V4 Error:', e)
            }
